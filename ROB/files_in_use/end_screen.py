...
player1_l = pygame.image.load('images/sprites/sune/walking_left_0.png')
player2_l = pygame.image.load('images/sprites/bob/walking_left_0_green.png')
player3_l = pygame.image.load('images/sprites/berit/walking_left_0_yellow.png')
player4_l = pygame.image.load('images/sprites/hannes/walking_left_0_purple.png')
